...
## Submission Type
Выпадающий список — вариантов я не видел. Выбирайте тот, что означает **новый хук, построенный
в этом хакатоне** (не продолжение старого проекта). Наш код написан с нуля в августе 2026.
